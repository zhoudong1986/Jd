...
$(function(){
 ...
 $timer2 = setInterval("doTurnF(false,$('#clothBox').children('.mc').find('.main').children('.slider').children('.slider-body').find('.slider-main'))",2500);
  //1F小球
  $('#clothBox').children('.mc').find('.main').children('.slider').find('.slider-nav').children('ul').find('li').click(function(){
      clearTimeout($timer2);
      $timer2 = null;
      var $index =  $(this).index();
      $sum1 = $index;
      $(this).addClass('.slider-selected').siblings('li').removeClass('.slider-selected');
  ...
  //小球事件
  $('#electronics').find('.slider-nav').children('ul').children('li').click(function(){
    clearTimeout($timer3);
    $timer3 = null;
    var $index =  $(this).index();
    $sum2 = $index;
