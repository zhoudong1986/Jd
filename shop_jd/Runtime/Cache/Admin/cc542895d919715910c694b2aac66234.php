    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <div class="panel-body ">
          <form id="forms" action="/Jd/index.php/Admin/User/doEdit" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5 ">
                  <img src="<?php echo ($user['pic']); ?>" width="80px" height="80px" alt="" class="img-thumbnail" />
              ...
              <div class="form-group">
                <div class="col-sm-offset-4 col-sm-5">
                  ...
                  <a href="/Jd/index.php/Admin/User/index" class="btn btn-danger btn-lg">返回</a>
                </div>
              </div>
