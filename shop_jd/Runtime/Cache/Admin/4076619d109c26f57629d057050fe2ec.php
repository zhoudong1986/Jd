          ...
          <td scope="row">
            ...
            <td>
              ...
              <td>
                ...
                " width="50px" height="50px" alt="..." class="img-thumbnail">
              </td>
              <td>
                <?php if($u['status'] == 1): ?><button class="btn btn-success " value="0" sid="<?php echo ($u['user_id']); ?>"><span class="glyphicon glyphicon-ok"></span></button>
                <button class="btn btn-default hide" value="1" sid="<?php echo ($u['user_id']); ?>"><span class="glyphicon glyphicon-lock"></span></button>
                <?php else: ?>
                <button class="btn btn-default" value="1" sid="<?php echo ($u['user_id']); ?>"><span class="glyphicon glyphicon-lock"></span></button>
                <button class="btn btn-success hide" value="0" sid="<?php echo ($u['user_id']); ?>"><span class="glyphicon glyphicon-ok"></span></button><?php endif; ?>
              </td>
              <td>
                ...
                <a href="/Jd/index.php/Admin/User/editPwd/id/<?php echo ($u['user_id']); ?>/name/<?php echo ($u['user_name']); ?>" class="btn btn-warning  ">
                    <span>修改密码</span>
                  </a>
