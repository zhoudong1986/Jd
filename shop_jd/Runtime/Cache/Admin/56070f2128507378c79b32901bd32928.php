...
<body>
  ...
  <div class="container">
    <form id="forms" action="/Jd/index.php/Admin/User/doEditPwd" class="form-horizontal" method="post">
        ...
        <div class="col-sm-offset-4 col-sm-3">
          ...
          <a class="btn btn-danger btn-lg" href="/Jd/index.php/Admin/User/admin">取消</a>
        </div>
        </div>
