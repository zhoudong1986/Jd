...
<head>
  ...
  <!-- Stylesheets -->
  <link href="/Jd/shop_jd/Admin/Public/css/bootstrap.css" rel="stylesheet">
  <!-- Font awesome icon -->
          ...
          <li class="dropdown">            
            ...
            <ul class="dropdown-menu " >
              <!-- <div class="btn-group-vertical"> -->&nbsp;&nbsp;
                <a href="" id="logoutbt"  data-toggle="modal" data-target=".person-modal">
                <span class="glyphicon glyphicon-user"></span>
                个人资料
                </a>
                <br />&nbsp;&nbsp;
                <a href="" id="logoutbt"  data-toggle="modal" data-target=".pwd-modal">
                <span class="glyphicon glyphicon-pencil"></span>
                修改密码
                </a>
                <br />&nbsp;&nbsp;
                <a id="logoutbt" href="" data-toggle="modal" data-target=".logout-modal">
              ...
              <div class="container">
                  ...
                  <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                      <div class="modal-body">
                          <div class="row">
                            <div class="col-sm-5 col-sm-offset-4" ><h3>系统提示</h3></div>
                ...
                <div class="modal fade pwd-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    修改密码
                  </div>
                </div>
                <div class="modal fade logout-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    退
                  </div>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li><a href="index.html" class="open"><i class="glyphicon glyphicon-home"></i> 首页</a>
            <!-- Sub menu markup 
            <ul>
                    ...
                    <ul class="chats">
                      ...
                      <li class="by-me">
                        ...
                        <div class="avatar pull-left">
                          <img src="/Jd/shop_jd/Admin/Public/images/user.jpg" alt=""/>
                        </div>
              ...
              <div class="widget">
                ...
                <div class="widget-content referrer">
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                      <td><img src="/Jd/shop_jd/Admin/Public/images/icons/chrome.png" alt="" />
                      <td>Google Chrome</td>
                      <td>3,005</td>
                    </tr> 
                    <tr>
                      <td><img src="/Jd/shop_jd/Admin/Public/images/icons/firefox.png" alt="" />
                      <td>Mozilla Firefox</td>
                      <td>2,505</td>
                    </tr> 
                    <tr>
                      <td><img src="/Jd/shop_jd/Admin/Public/images/icons/ie.png" alt="" />
                      <td>Internet Explorer</td>
                      <td>1,405</td>
                    </tr> 
                    <tr>
                      <td><img src="/Jd/shop_jd/Admin/Public/images/icons/opera.png" alt="" />
                      <td>Opera</td>
                      <td>4,005</td>
                    </tr> 
                    <tr>
                      <td><img src="/Jd/shop_jd/Admin/Public/images/icons/safari.png" alt="" />
                      <td>Safari</td>
                      <td>505</td>
                    </tr>                                                                    
                  </table>
...
<!-- JS -->
<script src="/Jd/shop_jd/Admin/Public/js/jquery-1.10.2.min.js"></script> <!-- jQuery -->
<script src="/Jd/shop_jd/Admin/Public/js/bootstrap.min.js"></script> <!-- Bootstrap -->
