...
<body>
  ...
  <div class="content">
    ...
    <div class="sidebar">
      ...
      <li class="has_sub">
        ...
        <ul>
          <li>
            <a href="widgets1.html">前台买家</a>
          </li>
          <li>
            <a href="widgets2.html">前台卖家</a>
          </li>
          <li>
            <a href="widgets3.html">后台管理员</a>
          </li>
        </ul>
      </li>
      <li class="has_sub">
        ...
        <ul>
          ...
          <li>
            <a href="support.html">帮助页</a>
          </li>
          <li>
            <a href="invoice.html">购物清单</a>
          </li>
          <li>
  ...
  <div class="mainbar">
    ...
    <div class="panel panel-info">
      ...
      <div class="panel-footer panel-default" style="text-align:right">
        <nav>
