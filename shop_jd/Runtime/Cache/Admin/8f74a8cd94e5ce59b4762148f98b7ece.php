...
<body>
                    ...
                    <div class="modal-body">
                      <form action="" class="form-horizontal">
                        <div class="form-group">
                          ...
                          <div class="col-sm-1">
                            <button type="button" class="close" onclick="cha();" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                        </div>
  ...
  <div class="content">
    ...
    <div class="sidebar">
      ...
      <li class="has_sub">
        ...
        <ul>
          <li>
            <a href="<?php echo U('User/index');?>">前台买家</a>
          </li>
          <li>
            <a href="">前台卖家</a>
          </li>
  ...
  <div class="mainbar">
    ...
    <iframe id="fram" src="<?php echo U('copyIndex');?>
      " width="1190" height="800" frameborder="no" name="adminFrame" border="0"  scrolling="no">
    </iframe>
    <!-- Matter -->
