...
<![endif]-->
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='/Jd/shop_jd/Seller/Public/css/jquery-2.0.3.min.js'>"+"<"+"script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/Jd/shop_jd/Seller/Public/js/jquery-1.10.2.min.js'>"+"<"+"script>");
</script>
<![endif]-->
	...
	<div style="display:block"><!-- <script src='http://v7.cnzz.com/stat.php?id=155540&web_id=155540' language='JavaScript' charset='gb2312'></script> --></div>
</body>
</html>