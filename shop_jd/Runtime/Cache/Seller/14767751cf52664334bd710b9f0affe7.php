...
<head>
  <meta charset="utf-8" />
  <link href="/Jd/shop_jd/Seller/Public/images/JD.ico" rel="icon">
...
<body>
  <div class="navbar navbar-default" id="navbar">
        ...
        <ul class="nav ace-nav">
          ...
          <li class="light-blue">
            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
              <!-- img的css样式在ace.min.css -->
              <img class="nav-user-photo" src="/Jd/shop_jd/Seller/Public/images/user.jpg" alt="<?php echo session('sname');?>
              Photo"
                                />
            ...
            <li>
              ...
              <ul class="submenu">
                ...
                <li>
                  <a href="#" class="dropdown-toggle">
                    <i class="icon-double-angle-right"></i>
                    三级菜单 <b class="arrow icon-angle-down"></b>
                  </a>
                  <ul class="submenu">
                    <li>
                      <a href="#">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="alert alert-block alert-success">
                  ...
                  欢迎使用 <strong class="green">Ace后台管理系统
                ...
                <div class="row">
                  ...
                  </div>  <!-- <div class="col-sm-7 infobox-container"> 的div-->
                  ...
                  <div class="col-sm-5">
                    ...
                    </div>  <!-- /widget-body --> <!-- <div class="widget-box">的div -->

                  </div>    <!-- /widget-box --> 
                  <!-- /span --> 
              </div>  <!-- <div class="row">的DIV -->
    ...
    -->
    <script type="text/javascript">
                    window.jQuery || document.write("<script src='/Jd/shop_jd/Seller/Public/css/jquery-2.0.3.min.js'>" + "<" + "script>");</script>
    <!-- <![endif]-->
    <!--[if IE]>
    <script type="text/javascript">
                        window.jQuery || document.write("<script src='/Jd/shop_jd/Seller/Public/js/jquery-1.10.2.min.js'>" + "<" + "script>");</script>
    <![endif]-->
    <script type="text/javascript">
                    if ("ontouchend" in document) document.write("<script src='/Jd/shop_jd/Seller/Public/js/jquery.mobile.custom.min.js'>" + "<" + "script>");</script>
    ...
    <!--[if lte IE 8]>
    <script src="/Jd/shop_jd/Seller/Public/js/excanvas.min.js"></script>
    <![endif]-->
