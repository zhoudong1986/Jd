...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/shop_jd/Home/Public/css/sendMailSuccess.css" media="all">
            ...
            <div id="content">
                ...
                <div id="main">
                    <div class="mod-main mod-comm">
                        ...
                        <div class="mc">
                            ...
                            <div class="safe-icon-box">
                                ...
                                <div class="fore">
                                    <h3>
                                        <span class="ftx-02">已发送验证邮件至：</span>
                                        <?php echo ($email); ?>&nbsp;&nbsp;
                                    </h3>
                                    <div class="ftx-01">（请立即完成验证，邮箱验证不通过则修改邮箱失败）</div>
                                    <div class="ftx-03">验证邮件24小时内有效，请尽快登录您的邮箱点击验证链接完成验证。</div>
                                    <div class="op-btns">
                                        <a class="btn-1" href="javascript:void(0);" onclick="window.location.href='http://mail.qq.com'">
                                            <b>查看验证邮件</b>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="mod-main mod-comm">
                        ...
                        <div class="mc">
                            <div>1. 请检查您的垃圾箱或者广告箱，邮件有可能被误认为垃圾或者广告邮件；</div>
                            <div>
                                2. 如果垃圾箱或广告箱也没收到,请尝试将customer_service@jd.com添加为收件人白名单(
                                <a href="http://help.jd.com/help/question-314.html">可参考邮箱白名单设置</a>
                                ),并且
                                <a href="javascript:resendBindMail();" id="resendBindMaila" class="btn btn-7">
                                    <s></s>
                                    重发验证邮件
                                </a>
                            </div>
