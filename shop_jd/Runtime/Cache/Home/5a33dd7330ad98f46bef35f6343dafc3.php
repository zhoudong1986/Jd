    ...
    <div class="w">
        <div id="logo">
            <a href="http://www.jd.com/" clstag="pageclick|keycount|20150112ABD|45">
                <img src="./images/logo-201305-b.png" alt="京东" height="60" width="170"></a> <b></b>
        </div>
    </div>
    <div id="content">
        <div class="login-wrap">
            ...
            <div class="login-banner" style="background-color: rgb(94, 143, 54);">
                <div class="w">
                    <div id="banner-bg" clstag="pageclick|keycount|20150112ABD|46" class="i-inner" style="background: rgb(94, 143, 54) url('./images/554ad450na30d68d6.jpg') no-repeat scroll 0px 0px;"></div>
                </div>
            </div>
        </div>
    </div>
