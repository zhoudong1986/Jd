...
<head>
	...
	<title>账户信息</title>
  <link rel="stylesheet" type="text/css" href="/shop_jd/Home/Public/css/more.css" media="all">
...
<!--样式一头部结束-->
					...
					<div class="mod-main">
						<div class="mt">
							<ul class="extra-l">
								...
								<li class="fore-3">
									<a class="curr" href="/index.php/Home/Member/more/uid/<?php echo ($_SESSION['login_info']['uid']); ?>">更多个人信息</a>
								</li>
							...
							<div class="user-set">
								<div class="form">
									...
									<div class="item">
										...
										<div class="fl">
											<input name="maritalStatus" class="jdradio"  value="1" type="radio">
											<label class="mr10">未婚</label>
											<input name="maritalStatus" class="jdradio"  value="2" type="radio">
											<label class="mr10">已婚</label>
											<input name="maritalStatus" class="jdradio" value="3" type="radio">
											<label class="mr10">保密</label>
										</div>
									</div>
									<div class="item">
										<span class="label">月收入：</span>
										<div class="fl" clstag="homepage|keycount|home2013|infomoreIncome">
									...
									<div class="item">
										...
										<div class="fl" clstag="homepage|keycount|home2013|infomoreadd">
											<div id="cidShowDiv" style="display: none;"> <strong></strong>
												<a class="smod" href="javascript:showCidDiv()">修改</a>
											</div>
											<div id="cidInputDIv" style="">
												<input name="id_card" id="cid" value="<?php echo ($info['id_card']); ?>" maxlength="18" class="itxt" type="text">
												<div class="clr"></div>
												<div class="prompt-06">
									...
									<div class="item">
										...
										<div class="fl" clstag="homepage|keycount|home2013|infomoreedu">
									...
									<!--<div class="item">-->
										...
										<!--<div class="fl" clstag="homepage|keycount|home2013|infomoreIndustry">-->
									...
									<div class="item">
										...
										<div class="fl">
											<a href="javascript:void(0)" class="btn-5">保存</a>
										</div>
									</div>
								</div>
							</div>
  ...
  <script>
    $(function(){
      //遍历选中数据库默认数据
       var monthlyIncome = <?php echo ($info['income']); ?>;
       var education = <?php echo ($info['educate']); ?>;
       var jdradio = <?php echo ($info['marriage']); ?>;
       var $s_jdradio = null;
      //收入
      $('#monthlyIncome').children('option').each(function(i){
        if($(this).val()==monthlyIncome){
      ...
      //教育程度
      $('#education').children('option').each(function(i){
      ...
      //婚否点击获取到所选值
      $('.jdradio').click(function(){
        $s_jdradio = $(this).val();
      });
      $('.btn-5').click(function(){
        var education = $('#education').val(); // 教育
        var monthlyIncome = $('#monthlyIncome').val(); //收入
        var id_card = $('#cid').val(); //身份证
        var jdradio = ''; //婚否
        $('.jdradio').each(function(i){
        ...
        //获取数据ajax后台保存到数据库
        $.ajax({
          url:'/index.php/Home/Member/actionMore',
          type:'post',
          data:{'educate':education,'id_card':id_card,'income':monthlyIncome,'marriage':$s_jdradio,'uid':<?php echo ($uid); ?>},
          success:function($msg){
            if($msg=='1'){
              alert('保存成功');
              window.location.href = "/index.php/Home/Member/more/uid/<?php echo ($_SESSION['login_info']['uid']); ?>";
            }
          }
        });
      });
