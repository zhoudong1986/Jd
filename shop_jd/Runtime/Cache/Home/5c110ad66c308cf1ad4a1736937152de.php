...
<dd class="fore1">
	<div class="item curr" id="_MYJD_ordercenter">
		<a target="_self" clstag="homepage|keycount|home2013|Homeoder" href="http://order.jd.com/center/list.action">我的订单</a>
	</div>
</dd>
<dd class="fore2">
	<div class="item" id="_MYJD_tuan">
		<a target="_top" clstag="homepage|keycount|home2013|Hometuan" href="http://tuan.jd.com/order/index.php">团购订单</a>
	</div>
</dd>
<dd class="fore3">
	<div class="item" id="_MYJD_locallife">
		<a target="_self" clstag="homepage|keycount|home2013|Homelife" href="http://life.jd.com/localOrder/iniOrder.do">本地生活订单</a>
	</div>
</dd>
<dd class="fore4">
	<div class="item" id="_MYJD_yushou">
		<a target="_self" clstag="homepage|keycount|home2013|Homeys" href="http://yushou.jd.com/member/qualificationList.action">我的预售</a>
	</div>
</dd>
<dd class="fore5">
