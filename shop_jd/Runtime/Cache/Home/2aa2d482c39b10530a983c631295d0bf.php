					...
					<div id="menu">
						<dl class="fore1">
							...
							<dd class="fore1_5" id="_MYJD_comments">
								<a href="http://club.jd.com/mycomments.aspx" target="_self">评价晒单</a>
							</dd>
							<dd class="fore1_6" id="_MYJD_refundment">
								<a target="_self">取消订单记录</a>
							</dd>
						</dl>
						<!--<dl class="fore2">-->
						...
						<dl class="fore4">
							...
							<dd class="fore6_2" id="_MYJD_add">
								<a clstag="homepage|keycount|home2013|Homeadd2" href="/index.php/Home/Member/myAddr/uid/<?php echo ($_SESSION['login_info']['uid']); ?>" target="_self">收货地址</a>
							</dd>
						</dl>
					</div>
					<div id="menu-ads">
