					...
					<div id="menu">
						...
						<dl class="fore3">
							...
							<dd class="fore3_1" id="_MYJD_cashbox">
								<a clstag="homepage|keycount|home2013|Homexjk" href="http://jinku.pay.jd.com/xjk/income.action" target="_self">小金库</a>
							</dd>
							<dd class="fore3_2" id="_MYJD_credit">
								<a target="_self" class="" clstag="homepage|keycount|home2013|hbt" tag="213" href="http://baitiao.jd.com/">京东白条</a>
							</dd>
							<dd class="fore3_3" id="_MYJD_balance">
								<a clstag="homepage|keycount|home2013|Homemoney" href="http://mymoney.jd.com/finance/recently.action" target="_self">余额</a>
							</dd>
							<dd class="fore3_4" id="_MYJD_ticket">
								<a clstag="homepage|keycount|home2013|Homequan" href="http://quan.jd.com/user_quan.action" target="_self">优惠券</a>
								&nbsp;
								<img src="/shop_jd/Home/Public/images/myjd-new-ico.png" height="11" width="24"></dd>
							<dd class="fore3_5" id="_MYJD_card">
								<a clstag="homepage|keycount|home2013|Homegift" href="http://giftcard.jd.com/giftcard/index.action" target="_self">京东卡/E卡</a>
							</dd>
							<dd class="fore3_6" id="_MYJD_bean">
								<a clstag="homepage|keycount|home2013|Homedou" href="http://bean.jd.com/myJingBean/list" target="_self">京豆</a>
							</dd>
						</dl>
						<dl class="fore4">
							<dt id="_MYJD_ts">特色业务</dt>
							<dd class="fore4_1" id="_MYJD_tc">
								<a clstag="homepage|keycount|home2013|Homemyyyt" href="http://dj.eve.jd.com/queryPacKageInfo.action" target="_self">我的营业厅</a>
							</dd>
							<dd class="fore4_2" id="_MYJD_tx">
								<a clstag="homepage|keycount|home2013|Homemobile" href="http://mobile.jd.com/yyswt/myjd.do" target="_self">京东通信</a>
							</dd>
							<dd class="fore4_3" id="_MYJD_ding">
								<a clstag="homepage|keycount|home2013|Homeding" href="http://ding.jd.com/plan/showPlans.action" target="_self">定期送</a>
							</dd>
						</dl>
						<dl class="fore5">
						...
						<dl class="fore6">
							...
							<dd class="fore6_1" id="_MYJD_info">
								<a clstag="homepage|keycount|home2013|Homeyser2" href="http://i.jd.com/user/info" target="_self">个人信息</a>
							</dd>
